...
You would need to call add_friendship() 1000 times. target_sum = # of users \* desired average because to find an average you have average = sum / total (users). In this case, 10 = sum / 100 users leads to 10 \* 100 = 1000.
